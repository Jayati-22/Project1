...
# # # Audio
# # audio_file_path = "stranger_things_theme.mp3"
# # audio_file = None
...
# # # Sidebar uploader for custom audio
# # with st.sidebar:
# #     st.header("🎵 Theme Song")
# #     uploaded_audio = st.file_uploader("Upload theme song (mp3)", type=["mp3", "wav"])
# #     if uploaded_audio:
# #         audio_file = uploaded_audio.read()

# # # Play audio
# # if audio_file:
# #     st.audio(audio_file, format="audio/mp3", loop=True)
# # else:
# #     st.sidebar.info("Upload 'stranger_things_theme.mp3' or use the uploader to play music!")
...
#     uploaded_audio = st.file_uploader("Upload theme song (mp3)", type=["mp3", "wav"])
#     if uploaded_audio:
#         # Save uploaded file to use as background music
...
# # Auto-play Audio
# if os.path.exists(audio_file_path):
#     bin_str = get_base64_of_bin_file(audio_file_path)
#     audio_html = """
...
# else:
#     st.sidebar.info("Upload 'stranger_things_theme.mp3' to hear the spooky tunes!")
...
def set_png_as_page_bg(png_file):
    ...
    /* Specific Title Styling with Flicker */
    h1 {
        font-size: 3.5rem !important;
        text-transform: uppercase;
        border-bottom: 2px solid #ff3333;
